...
const translations = {
    vi: {
        ...
        'Expense updated successfully': 'Cập nhật khoản chi tiêu thành công',
        'Expense added successfully': 'Thêm khoản chi tiêu thành công',
        'Are you sure you want to delete this expense?': 'Bạn có chắc chắn muốn xóa khoản chi tiêu này?',
        'Expense deleted successfully': 'Đã xóa khoản chi tiêu thành công',
        'View and manage your transaction history.': 'Xem và quản lý lịch sử giao dịch của bạn.',
        'Add Expense': 'Thêm chi tiêu',
        'Failed to delete expense': 'Không thể xóa khoản chi tiêu',
        'Income deleted successfully': 'Đã xóa khoản thu nhập thành công',
        'Failed to delete income': 'Không thể xóa khoản thu nhập',
        'Are you sure you want to delete this income?': 'Bạn có chắc chắn muốn xóa khoản thu nhập này?',
        'Recurring transaction deleted successfully': 'Đã xóa giao dịch định kỳ thành công',
        'Are you sure you want to delete this recurring transaction?': 'Bạn có chắc chắn muốn xóa giao dịch định kỳ này?',
        'User Management': 'Quản lý người dùng',
        'Manage user roles and permissions': 'Quản lý vai trò và quyền người dùng',
        'All Users': 'Tất cả người dùng',
        'Role updated successfully': 'Cập nhật vai trò thành công',
        'Failed to update role': 'Không thể cập nhật vai trò',
        'Failed to load users': 'Không thể tải danh sách người dùng',
        ...
        'Are you sure you want to delete user': 'Bạn có chắc chắn muốn xóa người dùng',
        'View all users in the system': 'Xem tất cả người dùng trong hệ thống',
        ...
        'e.g. Food, Transport': 'Ví dụ: Ăn uống, Giao thông',
        'e.g. Grocery Shopping': 'Ví dụ: Mua sắm tạp hóa',
        'Failed to add expense': 'Không thể thêm chi tiêu',
        ...
        'Failed to delete category': 'Không thể xóa hạng mục',
        'Please remove or reassign transactions first': 'Vui lòng xóa hoặc chuyển các giao dịch trước',
        ...
        'Add New Income': 'Thêm thu nhập mới',
        'Enter the details of your income here.': 'Nhập chi tiết thu nhập của bạn tại đây.',
        'e.g. Monthly Salary': 'Ví dụ: Lương tháng',
        'Income added successfully': 'Thêm thu nhập thành công',
        'Failed to add income': 'Không thể thêm thu nhập',
        ...
        'Gift': 'Quà tặng',
        'Income': 'Thu nhập',
        'Track and manage your income sources': 'Theo dõi và quản lý các nguồn thu nhập của bạn',
        'No income records yet': 'Chưa có bản ghi thu nhập nào',
        'Are you sure you want to delete this income?': 'Bạn có chắc muốn xóa thu nhập này?',
        'Income deleted successfully': 'Xóa thu nhập thành công',
        'Failed to delete income': 'Không thể xóa thu nhập',
        'Failed to load incomes': 'Không thể tải danh sách thu nhập',
        'Overview of your financial situation': 'Tổng quan tình hình tài chính của bạn',
        'Positive balance': 'Số dư dương',
        'Negative balance': 'Số dư âm',
        'All time income': 'Tổng thu nhập',
        'All time expenses': 'Tổng chi tiêu',
        'Failed to load dashboard data': 'Không thể tải dữ liệu dashboard',
        'Failed to load expenses': 'Không thể tải danh sách chi tiêu',
        ...
        'auth.heroTitle': 'Quản lý tài chính thông minh với AI',
        'auth.heroSubtitle': 'Theo dõi chi tiêu, phân tích xu hướng và nhận gợi ý tiết kiệm từ trợ lý ảo thông minh của bạn.',
        'auth.loginTitle': 'Chào mừng trở lại!',
        'auth.loginSubtitle': 'Vui lòng đăng nhập để tiếp tục.',
        'auth.registerTitle': 'Tạo tài khoản mới',
        'auth.registerSubtitle': 'Bắt đầu quản lý tài chính của bạn ngay hôm nay.',
        'auth.email': 'Email',
        ...
        // Footer & Hero
        'footer.tagline': 'Quản lý tài chính thông minh với sức mạnh của AI',
        'Product': 'Sản phẩm',
        'Company': 'Công ty',
        'Support': 'Hỗ trợ',
        ...
        'All rights reserved': 'Bản quyền thuộc về NDFolio',
        'Vietnam': 'Việt Nam',
        'Manage Your Finances Smarter': 'Quản lý tài chính thông minh hơn',
        'hero.description': 'Theo dõi chi tiêu, phân tích xu hướng và nhận gợi ý tiết kiệm từ trợ lý AI của bạn',
        'AI-Powered Insights': 'Phân tích thông minh AI',
        'Get smart financial advice powered by AI': 'Nhận tư vấn tài chính thông minh từ AI',
        'Expense Tracking': 'Theo dõi chi tiêu',
        'Track every expense automatically': 'Tự động theo dõi mọi khoản chi',
        'Visual Reports': 'Báo cáo trực quan',
        'Beautiful charts and analytics': 'Biểu đồ đẹp mắt và phân tích chi tiết',
        'Savings Goals': 'Mục tiêu tiết kiệm',
        'Set and achieve your financial goals': 'Đặt và đạt được mục tiêu tài chính',
        'Multi-language': 'Đa ngôn ngữ',
        'Vietnamese and English support': 'Hỗ trợ tiếng Việt và tiếng Anh',
        'Secure & Private': 'An toàn & Bảo mật',
        'Your data is encrypted and protected': 'Dữ liệu được mã hóa và bảo vệ',
    ...
    en: {
        ...
        'View all users in the system': 'View all users in the system',
        ...
        'e.g. Food, Transport': 'e.g. Food, Transport',
        'e.g. Grocery Shopping': 'e.g. Grocery Shopping',
        ...
        'Please remove or reassign transactions first': 'Please remove or reassign transactions first',
        ...
        'Enter the details of your income here.': 'Enter the details of your income here.',
        'e.g. Monthly Salary': 'e.g. Monthly Salary',
        'Income added successfully': 'Income added successfully',
        'Failed to add income': 'Failed to add income',
        ...
        'Income deleted successfully': 'Income deleted successfully',
        'Failed to delete income': 'Failed to delete income',
        'Failed to load incomes': 'Failed to load incomes',
        'Overview of your financial situation': 'Overview of your financial situation',
        'Positive balance': 'Positive balance',
        'Negative balance': 'Negative balance',
        'All time income': 'All time income',
        ...
        'auth.heroTitle': 'Smart Financial Management with AI',
        'auth.heroSubtitle': 'Track expenses, analyze trends, and get savings suggestions from your intelligent virtual assistant.',
        ...
        // Footer & Hero
        'footer.tagline': 'Smart financial management powered by AI',
        'Product': 'Product',
        'Company': 'Company',
        'Support': 'Support',
        'About Us': 'About Us',
        ...
        'Vietnam': 'Vietnam',
        'Manage Your Finances Smarter': 'Manage Your Finances Smarter',
        'hero.description': 'Track expenses, analyze trends, and get savings suggestions from your AI assistant',
        'AI-Powered Insights': 'AI-Powered Insights',
        'Get smart financial advice powered by AI': 'Get smart financial advice powered by AI',
        'Expense Tracking': 'Expense Tracking',
        'Track every expense automatically': 'Track every expense automatically',
        'Visual Reports': 'Visual Reports',
        'Beautiful charts and analytics': 'Beautiful charts and analytics',
        'Savings Goals': 'Savings Goals',
        'Set and achieve your financial goals': 'Set and achieve your financial goals',
        'Multi-language': 'Multi-language',
        'Vietnamese and English support': 'Vietnamese and English support',
        'Secure & Private': 'Secure & Private',
        'Your data is encrypted and protected': 'Your data is encrypted and protected',
        // RoleGuard & Access Control
...
"[project]/app/context/language-context.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
function LanguageProvider({ children }) {
    ...
    const t = (key)=>{
        const translation = __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$translations$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["translations"][language]?.[key];
...
_s(LanguageProvider, "Kvx14fZVDSFemHsV9w3Wys7y0Ak=");
_c = LanguageProvider;
...
//# sourceMappingURL=_e1f1520e._.js.map